#ifndef _GPIOCOMMON_H_
#define _GPIOCOMMON_H_

#include "memorymap.h"

#define TOTAL_GPIOX     8
...
#define GPIOB           GET_ADDR(PERIPHERAL_AHB1_BASE + GPIOB_OFFSET)
#define GPIOC           GET_ADDR(PERIPHERAL_AHB1_BASE + GPIOC_OFFSET)
#define GPIOD           GET_ADDR(PERIPHERAL_AHB1_BASE + GPIOD_OFFSET)
#define GPIOE           GET_ADDR(PERIPHERAL_AHB1_BASE + GPIOE_OFFSET)
#define GPIOF           GET_ADDR(PERIPHERAL_AHB1_BASE + GPIOF_OFFSET)
#define GPIOG           GET_ADDR(PERIPHERAL_AHB1_BASE + GPIOG_OFFSET)
#define GPIOH           GET_ADDR(PERIPHERAL_AHB1_BASE + GPIOH_OFFSET)
